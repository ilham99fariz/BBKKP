    ...
    <section class="py-12 md:py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <a href="<?php echo e(route('news.index')); ?>" class="bg-white border rounded-xl p-5 hover:shadow-md transition-shadow">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\aduh pusing\aduh pusing\resources\views/pages/media/index.blade.php ENDPATH**/ ?>