...
<?php $__env->startSection('title', 'Proses Sertifikasi Halal - BBSPJIKP'); ?>
<?php $__env->startSection('description', 'Tahapan dan prosedur sertifikasi halal di LPH BBSPJIKP'); ?>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="p-8">
                ...
                <section class="mb-12">
                    ...
                    <!-- Gambar Proses -->
                    <div class="flex my-1">
                    <img src="<?php echo e(asset('images/proses-sertifikasi.png')); ?>"
...
<div class="bg-[#2F8CD1] text-white rounded-xl p-5 w-fit ml-10 shadow-md">
    ...
    <ul class="space-y-1">
        <li class="flex items-center gap-2">
            ...
            <?php $audit202223 = public_path('files/Daftar-Audit-LPH-BBSPJIKKP-2022-2023-per20250801.pdf'); ?>
                <a href="<?php echo e(asset('files/Daftar-Audit-LPH-BBSPJIKKP-2022-2023-per20250801.pdf')); ?>" class="hover:underline flex items-center gap-2" target="_blank" rel="noopener noreferrer">
        ...
        <li class="flex items-center gap-2">
            <span class="w-2 h-2 bg-white rounded-full"></span>
            <?php $audit2024 = public_path('files/Daftar-Audit-LPH-BBSPJIKKP-2024-per20250801.pdf'); ?>
                <a href="<?php echo e(asset('files/Daftar-Audit-LPH-BBSPJIKKP-2024-per20250801.pdf')); ?>" class="hover:underline flex items-center gap-2" target="_blank" rel="noopener noreferrer">
                    <class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v12m0 0l-4-4m4 4l4-4"/></svg>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\alamak\resources\views/pages/halal-center/certification-process.blade.php ENDPATH**/ ?>