...
<?php $__env->startSection('title', 'Tambah Halaman Dinamis - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Tambah Halaman Dinamis'); ?>

<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <form action="<?php echo e(route('admin.dynamic-pages.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
&lt;ul&gt;
    &lt;li&gt;Item 1&lt;/li&gt;
    &lt;li&gt;Item 2&lt;/li&gt;
&lt;/ul&gt;'><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\aduh pusing\aduh pusing\resources\views/admin/dynamic-pages/create.blade.php ENDPATH**/ ?>