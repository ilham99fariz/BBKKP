...
<?php $__env->startSection('title', $service->title . ' - BALAI BESAR STANDARDISASI DAN PELAYANAN JASA INDUSTRI KULIT, PLASTIK, DAN KARET'); ?>
...
<section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-3xl md:text-4xl font-bold mb-4"><?php echo e($service->title); ?></h1>
            ...
            <div class="lg:col-span-2">
                ...
                <div class="mt-12 bg-blue-50 rounded-lg p-8">
                    ...
                    <p class="text-gray-600 mb-6">
                        Hubungi kami untuk konsultasi lebih lanjut dan informasi detail tentang layanan <?php echo e($service->title); ?>.
                    </p>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h4 class="font-semibold text-gray-900 mb-1"><?php echo e($relatedService->title); ?></h4>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($relatedService->description, 100)); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\aduh pusing\aduh pusing\resources\views/pages/services/show.blade.php ENDPATH**/ ?>