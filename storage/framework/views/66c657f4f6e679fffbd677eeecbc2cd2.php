            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Peta
                            Jalan</a></li>
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Gratifikasi</a>
                    </li>
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Laporan
                            Pelanggaran</a></li>
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Benturan
                            Kepentingan</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Keluhan dan
                            Pengaduan</a></li>
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Survey
                            Pelanggan</a></li>
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Kontak</a>
                    </li>
                    <li><a href="#" class="hover:text-blue-200 transition-colors duration-200">Kebijakan
                            Privasi</a></li>
                </ul>
...
<?php /**PATH E:\BBKKP\resources\views/partials/footer.blade.php ENDPATH**/ ?>