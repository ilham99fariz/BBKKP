    ...
    <?php if($page->hero_image || $page->hero_title || $page->hero_subtitle): ?>
        <section class="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
            <?php if($page->hero_image): ?>
                <div class="absolute inset-0 bg-cover bg-center opacity-20" style="background-image: url('<?php echo e(Storage::url($page->hero_image)); ?>')"></div>
            <?php endif; ?>
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-3xl">
                    <?php if($page->hero_title): ?>
                        <h1 class="text-4xl md:text-5xl font-bold mb-4"><?php echo e($page->hero_title); ?></h1>
                    <?php else: ?>
                        <h1 class="text-4xl md:text-5xl font-bold mb-4"><?php echo e($page->title); ?></h1>
                    <?php endif; ?>
                    <?php if($page->hero_subtitle): ?>
                        <p class="text-xl text-blue-100"><?php echo e($page->hero_subtitle); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\aduh pusing\aduh pusing\resources\views/pages/dynamic/show.blade.php ENDPATH**/ ?>