...
<?php $__env->startSection('title', 'Edit Partner - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Edit Partner'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow">
            ...
            <form action="<?php echo e(route('admin.partners.update', $partner)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['website_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="logo" class="block text-sm font-medium text-gray-700 mb-2">
                            <?php echo e($partner->logo ? 'Ganti Logo Partner' : 'Logo Partner'); ?>
                        ...
                        <input type="file" 
                               ...
                               id="logo" 
                               accept="image/*"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="is_active" 
                               value="1"
                               <?php echo e(old('is_active', $partner->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\alamak\resources\views/admin/partners/edit.blade.php ENDPATH**/ ?>