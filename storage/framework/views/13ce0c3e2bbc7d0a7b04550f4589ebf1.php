...
<?php $__env->startSection('title', 'Edit Konten - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Edit Konten: ' . ucfirst(str_replace('-', ' ', $type))); ?>

<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <form action="<?php echo e(route('admin.page-content.update', ['type' => $type, 'page' => $page])); ?>" method="POST"
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" id="title" name="title" value="<?php echo e(old('title', $page->title)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="<?php echo e(old('slug', $page->slug)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>"
                                    <?php echo e(old('category', $page->category) == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order"
                                value="<?php echo e(old('sort_order', $page->sort_order)); ?>" min="0"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="hero_title" name="hero_title"
                            value="<?php echo e(old('hero_title', $page->hero_title)); ?>"
                    ...
                    <div>
                        ...
                        <textarea id="hero_subtitle" name="hero_subtitle" rows="2"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"><?php echo e(old('hero_subtitle', $page->hero_subtitle)); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if($page->hero_image): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(Storage::url($page->hero_image)); ?>" alt="Hero Image"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                    <a href="<?php echo e(route('admin.page-content.index', ['type' => $type, 'category' => $page->category])); ?>"
    ...
    <script>
        CKEDITOR.replace('content', {
            ...
            filebrowserImageUploadUrl: '<?php echo e(route("admin.page-content.upload", ["type" => $type])); ?>',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\BBKKP\resources\views/admin/page-content/edit.blade.php ENDPATH**/ ?>