        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($stats['sliders'] ?? 0); ?></p>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">
                        <?php echo e(($stats['visits'] ?? 0) + ($stats['messages'] ?? 0)); ?>

                    </p>
                    <p class="text-xs text-gray-500"><?php echo e($stats['visits'] ?? 0); ?> kunjungan · <?php echo e($stats['messages'] ?? 0); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\alamak\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>