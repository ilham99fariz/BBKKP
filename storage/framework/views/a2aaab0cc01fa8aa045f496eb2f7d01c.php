                ...
                <div class="prose max-w-none">
                    ...
                    <section class="mb-12">
                        ...
                        <div class="mb-4">
                                ...
                                <?php if($tataImage): ?>
                                    <img src="<?php echo e($tataImage); ?>" alt="Tata Nilai" class="w-full rounded-lg shadow-md">
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\BBKKP\resources\views/pages/about/profil-singkat.blade.php ENDPATH**/ ?>