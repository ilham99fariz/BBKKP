        ...
        <?php if($sliders->count() > 0): ?>
            <div class="relative h-[400px] md:h-[500px] lg:h-[600px]">
                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="slider-item absolute inset-0 transition-opacity duration-[1500ms] ease-in-out <?php echo e($index === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'); ?>" 
                         data-slide="<?php echo e($index); ?>">
                        <img src="<?php echo e(Storage::url($slider->image)); ?>" 
                            alt="<?php echo e($slider->getTitleByLocale() ?? 'Slider Image'); ?>"
                             class="w-full h-full object-cover">
                        
                        <?php if($slider->getTitleByLocale() || $slider->getDescriptionByLocale() || $slider->link_url): ?>
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end">
                                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-20 w-full">
                                    <div class="max-w-3xl">
                                        <?php if($slider->getTitleByLocale()): ?>
                                            <h2 class="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                                                <?php echo e($slider->getTitleByLocale()); ?>

                                            </h2>
                                        <?php endif; ?>
                                        <?php if($slider->getDescriptionByLocale()): ?>
                                            <p class="text-lg md:text-xl text-white/90 mb-6">
                                                <?php echo e($slider->getDescriptionByLocale()); ?>

                                            </p>
                                        <?php endif; ?>
                                        <?php if($slider->link_url && $slider->getLinkTextByLocale()): ?>
                                            <a href="<?php echo e($slider->link_url); ?>" 
                                               class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-all transform hover:scale-105">
                                                <?php echo e($slider->getLinkTextByLocale()); ?>
                ...
                <?php if($sliders->count() > 1): ?>
                    ...
                    <div class="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex gap-2">
                        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="slider-dot w-3 h-3 rounded-full transition-all <?php echo e($index === 0 ? 'bg-white w-8' : 'bg-white/50'); ?>" 
                                    data-slide="<?php echo e($index); ?>">
                            </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                    <?php echo e(__('home.our_services')); ?>
                ...
                <?php $__currentLoopData = $servicesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            ...
                            <p class="text-gray-600 mb-4 text-center line-clamp-3 flex-grow"><?php echo e($service['description']); ?></p>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                    <?php echo e(__('home.news_updates')); ?>

                </h2>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                    <?php echo e(__('home.news_subtitle')); ?>
                ...
                <?php if($featured): ?>
                    <div class="lg:col-span-2 bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden transition-all transform hover:scale-[1.02] duration-300">
                        ...
                        <div class="p-8">
                            ...
                            <h3 class="text-3xl font-bold text-gray-900 mb-4 leading-tight"><?php echo e($featured->title); ?></h3>
                            <p class="text-gray-700 mb-6 text-lg"><?php echo e(Str::limit(strip_tags($featured->content), 200)); ?></p>
                            <a href="<?php echo e(route('news.show', $featured)); ?>"
                                ...
                                <?php echo e(__('home.read_more')); ?> <i class="fas fa-arrow-right ml-2"></i>
                            </a>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $others; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex gap-4 bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden transition-all transform hover:scale-[1.02] duration-300">
                            ...
                            <div class="p-4 flex-1 flex flex-col">
                                ...
                                <p class="text-gray-600 text-sm line-clamp-2 flex-grow mb-3"><?php echo e($article->excerpt); ?></p>
    ...
    <section class="bg-gray-50 py-16" id="testimonials">
        <div class="container mx-auto px-4">
            ...
            <p class="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
                <?php echo e(__('common.testimonials_subtitle_long')); ?>
            ...
            <?php if($testimonials->count()): ?>
                    ...
                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <?php if(!empty($testimonial->image)): ?>
                                <div class="mb-4">
                                    <img src="<?php echo e(Storage::url($testimonial->image)); ?>" alt="Lampiran review"
                ...
                <div class="text-center mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('testimonials.form')); ?>"
                        ...
                        <?php echo e(__('common.testimonials_submit')); ?>
                    ...
                    <a href="<?php echo e(route('testimonials.index')); ?>"
                        ...
                        <?php echo e(__('common.testimonials_view_all')); ?>
            ...
            <?php else: ?>
                <p class="text-center text-gray-500">
                    <?php echo e(__('common.testimonials_empty')); ?>
