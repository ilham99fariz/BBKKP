                ...
                <?php $__currentLoopData = $services->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow p-6 hover:shadow-xl transition h-full flex flex-col justify-between">
                        <div class="text-center">
                            ...
                            <a href="<?php echo e(route('services.show', $service)); ?>" class="text-blue-600 font-semibold hover:text-blue-700">Pelajari Lebih Lanjut <i class="fas fa-arrow-right ml-1"></i></a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\alamak\resources\views/pages/home.blade.php ENDPATH**/ ?>