        ...
        <div class="login-card">
            <div class="login-card-header">
                <div class="logo-circle">
                    <img src="<?php echo e(asset('images/logobalai.png')); ?>" alt="Logo Balai">
                </div>
            ...
            <div class="login-card-body">
                ...
                <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="Masukkan email Anda" required value="<?php echo e(old('email')); ?>">
...
<?php /**PATH C:\alamak\resources\views/auth/login-admin.blade.php ENDPATH**/ ?>