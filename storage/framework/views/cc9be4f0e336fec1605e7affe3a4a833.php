        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="<?php echo e(route('home')); ?>" class="flex-shrink-0 flex items-center">
                    <img class="h-6 w-auto xs:h-8 sm:h-10" src="<?php echo e(asset('images/logobalai.png')); ?>" alt="Logo">
            ...
            <div class="hidden lg:flex items-center space-x-1">
                ...
                <?php $__currentLoopData = $navbarMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($menu->children->isNotEmpty()): ?>
                        <!-- Dropdown Menu -->
                        <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                            <a href="<?php echo e($menu->full_url); ?>"
                                ...
                                <?php echo e($menu->display_title ?? $menu->title); ?>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e($menu->full_url); ?>"
                            ...
                            <?php if($menu->open_new_tab): ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>>
                            <?php echo e($menu->display_title ?? $menu->title); ?>
        ...
        <div class="px-4 py-4 space-y-1">
            ...
            <?php $__currentLoopData = $navbarMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($menu->children->isNotEmpty()): ?>
                    <!-- Mobile Dropdown -->
                    <div class="space-y-1">
                        <button @click="toggleMenu('<?php echo e('menu_' . $menu->id); ?>')" type="button"
                            ...
                            <span><?php echo e($menu->display_title ?? $menu->title); ?></span>
                            <svg class="h-5 w-5 transition-transform duration-200"
                                :class="openMenus['<?php echo e('menu_' . $menu->id); ?>'] ? 'rotate-180' : ''" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                    clip-rule="evenodd" />
                        ...
                        <div x-show="openMenus['<?php echo e('menu_' . $menu->id); ?>']" x-cloak class="pl-4 mt-1 space-y-1">
                            <?php $__currentLoopData = $menu->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($child->full_url); ?>"
