...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="icon" class="block text-sm font-medium text-gray-700 mb-2">Icon</label>
                            <input type="file" id="icon" name="icon" accept=".jpeg,.jpg,.png,.gif,.svg,.webp"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\alamak\resources\views/admin/services/create.blade.php ENDPATH**/ ?>