...
<?php $__env->startSection('title', 'Edit Testimoni - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Edit Testimoni'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow">
            ...
            <form action="<?php echo e(route('admin.testimonials.update', $testimonial)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="client_name" 
                               id="client_name" 
                               value="<?php echo e(old('client_name', $testimonial->client_name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="client_company" 
                               id="client_company" 
                               value="<?php echo e(old('client_company', $testimonial->client_company)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                  required><?php echo e(old('content', $testimonial->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="1" <?php echo e(old('rating', $testimonial->rating) == '1' ? 'selected' : ''); ?>>1 Bintang</option>
                            <option value="2" <?php echo e(old('rating', $testimonial->rating) == '2' ? 'selected' : ''); ?>>2 Bintang</option>
                            <option value="3" <?php echo e(old('rating', $testimonial->rating) == '3' ? 'selected' : ''); ?>>3 Bintang</option>
                            <option value="4" <?php echo e(old('rating', $testimonial->rating) == '4' ? 'selected' : ''); ?>>4 Bintang</option>
                            <option value="5" <?php echo e(old('rating', $testimonial->rating) == '5' ? 'selected' : ''); ?>>5 Bintang</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            <?php echo e($testimonial->image ? 'Ganti Foto Klien' : 'Foto Klien'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\aduh pusing\aduh pusing\resources\views/admin/testimonials/edit.blade.php ENDPATH**/ ?>