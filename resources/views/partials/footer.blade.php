        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-6">
                    ...
                    <div class="text-xs space-y-1">
                        <div class="flex items-center">
                            ...
                            <span class="w-28">Senin - Kamis</span>
                            <span>: 08:00 - 15:30</span>
                        </div>
                        <div class="flex items-center">
                            <i class="far fa-clock mr-2 w-4"></i>
                            <span class="w-28">Jumat</span>
                            <span>: 08:00 - 16:00</span>
                        </div>
                        <div class="flex items-center">
                            <i class="far fa-calendar-times mr-2 w-4"></i>
                            <span class="w-28">Sabtu, Ahad</span>
                            <span>: Tutup</span>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="hidden md:block">
                    <h3 class="text-base font-bold mb-4 uppercase">Layanan</h3>
                    <ul class="space-y-2 text-sm">
                        @if($footerLayanan && $footerLayanan->children->isNotEmpty())
                            @foreach($footerLayanan->children as $item)
                                <li><a href="{{ $item->full_url }}" class="hover:text-blue-200 transition-colors duration-200" @if($item->open_new_tab) target="_blank" rel="noopener noreferrer" @endif>{{ $item->title }}</a></li>
                            @endforeach
                        @endif
                    </ul>
                </div>
            ...
            <div>
                <!-- Desktop version -->
                <div class="hidden md:block">
                    <h3 class="text-base font-bold mb-4 uppercase">Standar Pelayanan</h3>
                    <ul class="space-y-2 text-sm mb-6">
                        @if($footerStandar && $footerStandar->children->isNotEmpty())
                ...
                <div class="md:hidden" x-data="{ open: false }">
                    ...
                    <ul class="space-y-2 text-sm mb-6" x-show="open" x-cloak>
                        @if($footerStandar && $footerStandar->children->isNotEmpty())
                            @foreach($footerStandar->children as $item)
                                <li><a href="{{ $item->full_url }}" class="hover:text-blue-200 transition-colors duration-200" @if($item->open_new_tab) target="_blank" rel="noopener noreferrer" @endif>{{ $item->title }}</a></li>
                            @endforeach
            ...
            <div>
                <!-- Desktop version -->
                <div class="hidden md:block">
                    <h3 class="text-base font-bold mb-4 uppercase">Media & Informasi</h3>
                    <ul class="space-y-2 text-sm mb-6">
                ...
                <!-- Mobile version -->
                <div class="md:hidden" x-data="{ openMedia: false }">
                    <button @click="openMedia = !openMedia" class="w-full flex items-center justify-between text-base font-bold mb-4 uppercase">
                        <span>Media & Informasi</span>
                        <svg class="h-5 w-5 transition-transform duration-200" :class="{ 'rotate-180': openMedia }" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                    </button>
                    <ul class="space-y-2 text-sm mb-6" x-show="openMedia" x-cloak>
                        @foreach($footerMedia as $item)
                            <li><a href="{{ $item->full_url }}" class="hover:text-blue-200 transition-colors duration-200" @if($item->open_new_tab) target="_blank" rel="noopener noreferrer" @endif>{{ $item->title }}</a></li>
                        @endforeach
                    </ul>
            ...
            <div>
                <!-- Desktop version -->
                <div class="hidden md:block">
                    <h3 class="text-base font-bold mb-4 uppercase">Tentang Kami</h3>
                    <ul class="space-y-2 text-sm mb-6">
                        @foreach($footerTentang as $item)
                            <li><a href="{{ $item->full_url }}" class="hover:text-blue-200 transition-colors duration-200" @if($item->open_new_tab) target="_blank" rel="noopener noreferrer" @endif>{{ $item->title }}</a></li>
                        @endforeach
                    </ul>
                </div>
                ...
                <!-- Mobile version -->
                <div class="md:hidden" x-data="{ openTentang: false }">
                    <button @click="openTentang = !openTentang" class="w-full flex items-center justify-between text-base font-bold mb-4 uppercase">
                        <span>Tentang Kami</span>
                        <svg class="h-5 w-5 transition-transform duration-200" :class="{ 'rotate-180': openTentang }" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                    </button>
                    <ul class="space-y-2 text-sm mb-6" x-show="openTentang" x-cloak>
                        @foreach($footerTentang as $item)
                            <li><a href="{{ $item->full_url }}" class="hover:text-blue-200 transition-colors duration-200" @if($item->open_new_tab) target="_blank" rel="noopener noreferrer" @endif>{{ $item->title }}</a></li>
                        @endforeach
                    </ul>
