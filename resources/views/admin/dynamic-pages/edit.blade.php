...
@section('title', 'Edit Halaman Dinamis - Admin Panel')
@section('page-title', 'Edit Halaman Dinamis')
            ...
            <form action="{{ route('admin.dynamic-pages.update', $dynamicPage) }}" method="POST"
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', $dynamicPage->title) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="{{ old('slug', $dynamicPage->slug) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="type" name="type"
                                ...
                                @foreach ($types as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('type', $dynamicPage->type) == $key ? 'selected' : '' }}>
                                        {{ $label }}</option>
                                @endforeach
                            </select>
                            @error('type')
                        ...
                        <div>
                            ...
                            <input type="text" id="category" name="category"
                                value="{{ old('category', $dynamicPage->category) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order"
                                value="{{ old('sort_order', $dynamicPage->sort_order) }}" min="0"
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="is_active" name="is_active" value="1"
                                {{ old('is_active', $dynamicPage->is_active) ? 'checked' : '' }}
                    ...
                    <div>
                        ...
                        <input type="text" id="hero_title" name="hero_title"
                            value="{{ old('hero_title', $dynamicPage->hero_title) }}"
                    ...
                    <div>
                        ...
                        <textarea id="hero_subtitle" name="hero_subtitle" rows="2"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('hero_subtitle', $dynamicPage->hero_subtitle) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        @if ($dynamicPage->hero_image)
                            <div class="mb-2">
                                <img src="{{ Storage::url($dynamicPage->hero_image) }}" alt="Hero Image"
...
&lt;ul&gt;
    &lt;li&gt;Item 1&lt;/li&gt;
    &lt;li&gt;Item 2&lt;/li&gt;
&lt;/ul&gt;'>{{ old('content', $dynamicPage->content) }}</textarea>
