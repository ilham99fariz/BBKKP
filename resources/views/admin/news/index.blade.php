                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="text-xs text-gray-500">Oleh: {{ $item->author }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 max-w-md">
                                    <div class="line-clamp-2">{{ Str::limit($item->excerpt ?? strip_tags($item->content), 100) }}</div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('admin.news.toggle-publish', $item) }}" method="POST" class="inline">
                                        @csrf
                                        <button type="submit" 
                                                class="text-{{ $item->is_published ? 'yellow' : 'green' }}-600 hover:text-{{ $item->is_published ? 'yellow' : 'green' }}-900"
