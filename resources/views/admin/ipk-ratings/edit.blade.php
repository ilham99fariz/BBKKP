                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title', $ipkRating->title) }}"
                                    ...
                                    placeholder="Contoh: Indeks Persepsi Korupsi">
                            ...
                            <div>
                                ...
                                <input type="text" name="title_id" id="title_id" value="{{ old('title_id', $ipkRating->title_id) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="title_en" id="title_en" value="{{ old('title_en', $ipkRating->title_en) }}"
                                    ...
                                    placeholder="Example: Corruption Perception Index">
                                @error('title_en')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
