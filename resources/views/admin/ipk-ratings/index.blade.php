...
@section('title', 'Manajemen Skor IPK - Admin Panel')
@section('page-title', 'Manajemen Skor IPK')

@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Indeks Persepsi Korupsi (IPK)</h1>
        <a href="{{ route('admin.ipk-ratings.create') }}"
            class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200">
            <i class="fas fa-plus mr-2"></i>Tambah Skor IPK
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-4 bg-gray-50 flex justify-end space-x-2">
                <a href="{{ route('admin.ipk-ratings.edit', $rating) }}"
                    class="px-3 py-1.5 bg-indigo-600 text-white text-sm rounded hover:bg-indigo-700 transition-colors">
                    <i class="fas fa-edit mr-1"></i>Edit
                </a>
                <form action="{{ route('admin.ipk-ratings.destroy', $rating) }}" method="POST"
                    class="inline"
                    onsubmit="return confirm('Apakah Anda yakin ingin menghapus skor IPK ini?')">
                    @csrf
                    @method('DELETE')
        ...
        <div class="col-span-full">
            <div class="bg-white rounded-lg shadow p-12 text-center">
                ...
                <p class="text-lg font-medium text-gray-900">Belum ada skor IPK</p>
                <p class="text-sm text-gray-500 mb-4">Mulai dengan menambahkan skor IPK pertama Anda</p>
                <a href="{{ route('admin.ipk-ratings.create') }}"
