                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title_id" id="title_id" value="{{ old('title_id', $slider->title_id) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="description_id" id="description_id" rows="3"
                                ...
                                placeholder="Deskripsi singkat untuk slider ini">{{ old('description_id', $slider->description_id) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description_en" id="description_en" rows="3"
                                ...
                                placeholder="Short description for this slider">{{ old('description_en', $slider->description_en) }}</textarea>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="link_text_id" id="link_text_id"
                                    value="{{ old('link_text_id', $slider->link_text_id) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="link_text_en" id="link_text_en"
                                    value="{{ old('link_text_en', $slider->link_text_en) }}"
