...
@section('title', 'Tambah Curve Rating - Admin Panel')
@section('page-title', 'Tambah Curve Rating')
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Tambah Curve Rating</h1>
        </div>

        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.curve-ratings.store') }}" method="POST">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1 space-x-2">
                                <input type="color" name="line_color" id="line_color" value="{{ old('line_color', '#10B981') }}"
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="label_year1" id="label_year1" value="{{ old('label_year1', '2021') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="2021" required>
                            </div>
                            <div>
                                <label for="value1" class="block text-sm font-medium text-gray-700">Nilai (0-6)</label>
                                <input type="number" name="value1" id="value1" value="{{ old('value1', 0) }}" step="0.01"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="label_year2" id="label_year2" value="{{ old('label_year2', '2022') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="2022" required>
                            </div>
                            <div>
                                <label for="value2" class="block text-sm font-medium text-gray-700">Nilai (0-6)</label>
                                <input type="number" name="value2" id="value2" value="{{ old('value2', 0) }}" step="0.01"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    min="0" max="6" required>
                            </div>
                        </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="label_year3" id="label_year3" value="{{ old('label_year3', '2023') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="2023" required>
                            </div>
                            <div>
                                <label for="value3" class="block text-sm font-medium text-gray-700">Nilai (0-6)</label>
                                <input type="number" name="value3" id="value3" value="{{ old('value3', 0) }}" step="0.01"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    min="0" max="6" required>
                            </div>
                        </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="label_year4" id="label_year4" value="{{ old('label_year4', '2024') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="2024" required>
                            </div>
                            <div>
                                <label for="value4" class="block text-sm font-medium text-gray-700">Nilai (0-6)</label>
                                <input type="number" name="value4" id="value4" value="{{ old('value4', 0) }}" step="0.01"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    min="0" max="6" required>
                            </div>
                        </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="label_year5" id="label_year5" value="{{ old('label_year5', '2025') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="2025" required>
                            </div>
                            <div>
                                <label for="value5" class="block text-sm font-medium text-gray-700">Nilai (0-6)</label>
                                <input type="number" name="value5" id="value5" value="{{ old('value5', 0) }}" step="0.01"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    min="0" max="6" required>
                            </div>
                        </div>
