                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title', $serviceRating->title) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="title_id" id="title_id" value="{{ old('title_id', $serviceRating->title_id) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="title_en" id="title_en" value="{{ old('title_en', $serviceRating->title_en) }}"
