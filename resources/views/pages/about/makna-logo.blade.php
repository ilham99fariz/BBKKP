                ...
                <div class="prose max-w-none">
                    ...
                    <div class="flex justify-center mb-12">
                        <div class="w-64 h-64 bg-white rounded-lg shadow-lg p-4 flex items-center justify-center">
                            <img src="{{ asset('images/logo-full.png') }}" alt="Logo BBSPJIKP" class="max-w-full max-h-full">
                        </div>
                    </div>
                        ...
                        <div class="flex items-start gap-6">
                            <div class="w-32 flex-shrink-0">
                                @if (file_exists(public_path('images/logo1.png')))
                                    <img src="{{ asset('images/logo1.png') }}" alt="Gear 5 gigi" class="w-32 h-32 object-contain">
                        ...
                        <div class="flex items-start gap-6">
                            <div class="w-32 flex-shrink-0">
                                @if (file_exists(public_path('images/logo2.png')))
                                    <img src="{{ asset('images/logo2.png') }}" alt="Polimer" class="w-32 h-32 object-contain">
                        ...
                        <div class="flex items-start gap-6">
                            <div class="w-32 flex-shrink-0">
                                @if (file_exists(public_path('images/logo3.png')))
                                    <img src="{{ asset('images/logo3.png') }}" alt="Bidang Lain" class="w-32 h-32 object-contain">
                                @elseif (file_exists(public_path('images/logo3.png')))
                                    <img src="{{ asset('images/logo3.png') }}" alt="Bidang Lain" class="w-32 h-32 object-contain">
                                @else
                                    <div class="w-32 h-32 bg-gray-100 rounded flex items-center justify-center text-gray-400">Gambar</div>
                                @endif
