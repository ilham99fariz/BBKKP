                        ...
                        <div class="flex flex-col md:flex-row gap-8">
                            <div class="md:w-1/3">
                                <div class="aspect-w-4 aspect-h-5 rounded-lg overflow-hidden bg-gray-100">
                                    <img src="{{ asset('images/pejabat/kepala-balai.jpg') }}" alt="Kepala Balai" class="w-full h-full object-cover">
                                </div>
                            </div>
                            <div class="md:w-2/3">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                <div class="aspect-w-4 aspect-h-5 rounded-lg overflow-hidden bg-gray-100 mb-4">
                                    <img src="{{ asset('images/pejabat/pejabat-1.jpg') }}" alt="Nama Pejabat 1" class="w-full h-full object-cover">
                                </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                <div class="aspect-w-4 aspect-h-5 rounded-lg overflow-hidden bg-gray-100 mb-4">
                                    <img src="{{ asset('images/pejabat/pejabat-2.jpg') }}" alt="Nama Pejabat 2" class="w-full h-full object-cover">
                                </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                <div class="aspect-w-4 aspect-h-5 rounded-lg overflow-hidden bg-gray-100 mb-4">
                                    <img src="{{ asset('images/pejabat/pejabat-3.jpg') }}" alt="Nama Pejabat 3" class="w-full h-full object-cover">
                                </div>
