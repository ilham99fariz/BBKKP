        ...
        <div class="px-6 py-3 text-gray-600">
            ...
            <ul class="list-disc pl-6 space-y-2">
                <li>
                    ...
                    dan/atau tempat tertentu dari produk setelah memperoleh sertifikat halal. Untuk outlet restoran, label halal dipasang hanya pada outlet yang telah
                    masuk dalam lingkup sertifikat halal yang telah diterbitkan. Label Halal ditetapkan oleh BPJPH.
                    <span class="italic">– UU No. 33 Tahun 2014 –</span>
                </li>

                <li>
                    Label halal Indonesia merupakan sebuah rangkaian yang terdiri atas Logo Halal Indonesia yang disertai dengan nomor Sertifikat Halal yang ditampilkan dalam satu kesatuan. Adapun label halal yang lama masih bisa digunakan sampai dengan 2 Februari 2026 dalam rangka menghabiskan stok kemasan.
...
<div class="faq-item border rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="faq-content max-h-0 overflow-hidden transition-all duration-300">
        <div class="px-6 py-3 text-gray-600">
            ...
            Jadi, jika produk Anda baru memperoleh *Ketetapan Halal*, maka proses sertifikasi belum selesai.
            Masih ada satu tahap lagi yaitu penerbitan *Sertifikat Halal* oleh BPJPH agar nomor sertifikat halal
...
<div class="faq-item border rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="px-6 py-3 text-gray-600 leading-relaxed space-y-3">
        ...
        <p class="text-gray-600">
            Saat ini, 
            <span class="text-gray-700 font-semibold">Sertifikat Halal berlaku sejak diterbitkan oleh BPJPH dan tetap berlaku selama tidak terdapat perubahan 
