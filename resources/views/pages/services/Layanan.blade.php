...
@section('content')
    ...
    <section class="relative bg-gray-900">
        ...
        <div class="absolute inset-0">
            <img src="{{ asset('images/Pengujian2.png') }}" alt="Header Background" class="w-full h-full object-cover">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <!-- Sertifikasi -->
            <a href="{{ url('/sertifikasi') }}" class="group h-full flex">
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:translate-y-[-4px] hover:shadow-xl">
                    <div class="h-48 overflow-hidden">
                        <img src="{{ asset('images/Sertifikasi1.png') }}" alt="Proses Sertifikasi"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6 flex flex-col flex-1">
                        <h2 class="text-xl font-semibold text-gray-900 mb-2 group-hover:text-blue-600">
            ...
            <a href="{{ url('/bimbingan-teknis-konsultasi') }}" class="group">
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:translate-y-[-4px] hover:shadow-xl flex flex-col h-full">
                    <div class="h-48 overflow-hidden">
                        <img src="{{ asset('images/konsultasi.png') }}" alt="Peraturan dan Pedoman"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6 flex flex-col flex-1">
            ...
            <!-- Inspeksi -->
            <a href="{{ url('/inspeksi') }}" class="group">
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:translate-y-[-4px] hover:shadow-xl flex flex-col h-full">
                    <div class="h-48 overflow-hidden">
            ...
            <!-- Uji Profisiemsi -->
            <a href="{{ url('/uji-profisiensi') }}" class="group">
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:translate-y-[-4px] hover:shadow-xl flex flex-col h-full">
                    <div class="h-48 overflow-hidden">
            ...
            <a href="{{ url('/produsen-bahan-acuan') }}" class="group">
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:translate-y-[-4px] hover:shadow-xl">
                    <div class="h-48 overflow-hidden">
            ...
            <!-- Edukasi -->
            <a href="{{ url('/edukasi') }}" class="group">
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:translate-y-[-4px] hover:shadow-xl">
                    <div class="h-48 overflow-hidden">
