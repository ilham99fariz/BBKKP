...
@section('title', 'Keterbukaan Informasi Publik - BBSPJIKKP')
@section('description', 'Keterbukaan Informasi Publik - informasi dan dokumen terkait BBSPJIKKP')
    ...
    <section class="py-20">
        <div class="max-w-3xl mx-auto px-4 text-center">
            <div class="bg-white border rounded-lg p-8 shadow-sm">
                ...
                <a href="{{ route('media.index') ?? url('/media-informasi') }}" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">Kembali ke Media dan Informasi</a>
            </div>
        </div>
    </section>
@endsection
