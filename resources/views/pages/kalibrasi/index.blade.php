...
@section('title', 'Layanan Kalibrasi - BBSPJIKP')
@section('description', 'Laboratorium Kalibrasi BBSPJIKKP yang terakreditasi KAN dengan nomor LK-085-IDN')
...
@section('content')
    ...
    <div class="relative bg-gray-900">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="text-gray-300">{{ __('common.calibration') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">{{ __('kalibrasi.hero_title') }}</h1>
                <p class="text-xl text-gray-300 max-w-3xl mx-auto">
                    {{ __('kalibrasi.hero_subtitle') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <!-- Section Deskripsi -->
        <section class="mb-16">
            <h2 class="text-3xl font-bold text-gray-900 mb-6">{{ __('kalibrasi.calibration') }}</h2>
            <h3 class="text-2xl font-semibold text-gray-800 mb-4">{{ __('kalibrasi.calibration_lab') }}</h3>

            <div class="prose max-w-none text-gray-700 space-y-4">
                <p>
                    {{ __('kalibrasi.intro_text_1') }}
                </p>
                <p>
                    {{ __('kalibrasi.intro_text_2') }}
                </p>
                <p>
                    {{ __('kalibrasi.intro_text_3') }}
                </p>
                <p>
                    <a href="https://drive.google.com/drive/folders/1WzkiIqyblkmRUpKo0z6VwFDgzeEQzTvN" target="_blank"
                        ...
                        {{ __('kalibrasi.view_download_certificate') }}
                    </a>
                </p>
                <p class="text-lg font-semibold text-gray-800 mt-6">
                    {{ __('kalibrasi.our_motto') }} : <span class="text-blue-600">{{ __('kalibrasi.motto_text') }}</span>
                </p>
            </div>
        </section>
        ...
        <section class="mb-16">
            <h2 class="text-3xl font-bold text-gray-900 mb-6">{{ __('kalibrasi.calibration_services') }}</h2>
            ...
            <div class="border-b border-gray-200 mb-6">
                <nav class="flex space-x-8" aria-label="Tabs">
                    ...
                    <button onclick="showTab('permohonan')" id="tab-permohonan"
                        ...
                        {{ __('kalibrasi.calibration_request') }}
                    </button>
                    <button onclick="showTab('data')" id="tab-data"
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                        {{ __('kalibrasi.calibration_data') }}
                    </button>
                    <button onclick="showTab('sop')" id="tab-sop"
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                        {{ __('kalibrasi.sop_calibration') }}
                    </button>
                    <button onclick="showTab('tarif')" id="tab-tarif"
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                        {{ __('kalibrasi.calibration_rate') }}
                    </button>
                </nav>
            </div>
            ...
            <div id="content-deskripsi" class="tab-content">
                <div class="prose max-w-none text-gray-700">
                    <p>
                        {{ __('kalibrasi.calibration_services_desc') }}
                    </p>
                    <p>
                        {{ __('kalibrasi.accreditation_info') }}
                    </p>
                </div>
            </div>
        ...
        <section class="mb-16">
            <h2 class="text-3xl font-bold text-gray-900 mb-8">{{ __('kalibrasi.laboratory_capabilities') }}</h2>

            <!-- 1. MASSA -->
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">1. {{ __('kalibrasi.mass') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <!-- 2. SUHU -->
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">2. {{ __('kalibrasi.temperature') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">3. {{ __('kalibrasi.volumetric_equipment') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <!-- 4. GAYA -->
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">4. {{ __('kalibrasi.force') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <!-- 5. TEKANAN -->
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">5. {{ __('kalibrasi.pressure') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">6. {{ __('kalibrasi.analytical_instruments') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <!-- 7. DIMENSI -->
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">7. {{ __('kalibrasi.dimensions') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">8. {{ __('kalibrasi.time_frequency') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
            ...
            <div class="mb-12">
                <h3 class="text-2xl font-semibold text-gray-800 mb-4">{{ __('kalibrasi.non_accredited_scope') }}</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                        <thead class="bg-gray-100">
                            <tr>
